...
public enum RequestMethods {
    ...
    GET_LIQUIDITY_QUEUE, GET_ACCOUNT_HISTORY, GET_WITNESS_BY_ACCOUNT, GET_DISCUSSIONS_BY_AUTHOR_BEFORE_DATE, GET_ACCOUNT_VOTES, GET_ACTIVE_VOTES, GET_WITNESS_COUNT,
