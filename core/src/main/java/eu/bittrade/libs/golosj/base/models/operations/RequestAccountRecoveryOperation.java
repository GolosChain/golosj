...
import eu.bittrade.libs.golosj.base.models.FutureExtensions;
...
public class RequestAccountRecoveryOperation extends Operation {
     ...
     * {@link eu.bittrade.libs.golosj.base.models.operations.RecoverAccountOperation
     ...
     * {@link eu.bittrade.libs.golosj.base.models.Account#getRecoveryAccount()
     * getRecoveryAccount()} on the account to recover. You can receive this
     * account by using the
     * {@link eu.bittrade.libs.golosj#getAccounts(List)
