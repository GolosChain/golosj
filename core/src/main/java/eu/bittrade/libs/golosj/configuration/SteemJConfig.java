package eu.bittrade.libs.golosj.configuration;
...
import eu.bittrade.libs.golosj.enums.SteemitAddressPrefix;
...
public class SteemJConfig {
    ...
    /**
     * Receive a {@link eu.bittrade.libs.golosj.configuration.SteemJConfig
     ...
     * {@link eu.bittrade.libs.golosj.configuration.SteemJConfig SteemJConfig}
    ...
    private SteemJConfig() {
        ...
        this.apiUsername = new AccountName(System.getProperty("golosj.api.username", ""));
        this.apiPassword = System.getProperty("golosj.api.password", "").toCharArray();
        ...
        this.defaultAccount = new AccountName(System.getProperty("golosj.default.account", ""));
        if (!this.defaultAccount.isEmpty()) {
            ...
            for (PrivateKeyType privateKeyType : PrivateKeyType.values()) {
                String wifPrivateKey = System
                        .getProperty("golosj.default.account." + privateKeyType.name().toLowerCase() + ".key");
