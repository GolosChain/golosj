...
public interface FollowApiMethods {
     ...
     * @param limit       The number of results. works only before HF_18
     * @return A list of
     * {@link eu.bittrade.libs.golosj.apis.follow.model.AccountReputation
     * AccountReputation}.
     * @throws SteemCommunicationException <ul>
     *                                     <li>If the server was not able to answer the request in the
     *                                     given time (see
     ...
     * SINCE HF_18
     *
     * @param accountName list of account, which reputation is needed to retreive.
     * @return A list of
     * {@link eu.bittrade.libs.golosj.apis.follow.model.AccountReputation
     * AccountReputation}.
     * @throws SteemCommunicationException <ul>
     ...
     *                                     </ul>
     */
    List<AccountReputation> getAccountReputations(List<AccountName> accountName)
            throws SteemCommunicationException;
